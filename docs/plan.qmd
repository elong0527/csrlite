...
| **Task** | **Human Input** | **AI Output** | **Human Review** |
|----------|-----------------|---------------|------------------|
| Plan Creation | Protocol requirements | YAML structure | Approve/modify specifications |
| Implementation | Approved YAML | Production code | Code review and testing |
| Documentation | Scientific context | Auto-generated docs | Final approval and sign-off |
| Validation | Expected outcomes | Test scenarios | Results verification |
