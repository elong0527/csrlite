...
<embed src="examples/pdf/ae_summary_apat_week12_any_rel_ser.pdf" style="width:100%; height:600px" type="application/pdf">

<embed src="examples/pdf/ae_summary_apat_week24_any_rel_ser.pdf" style="width:100%; height:600px" type="application/pdf">
...
```{python}
#| echo: false
converter.convert("examples/rtf/ae_summary.rtf", output_dir="docs/pdf/", format="pdf", overwrite=True)
```
...
```{python}
#| echo: false
converter.convert("examples/rtf/ae_summary_step.rtf", output_dir="docs/pdf/", format="pdf", overwrite=True)
```
