...
from tlfyaml.ae.ae_summary import ae_summary_ard, ae_summary_df, ae_summary_rtf, ae_summary
```
...
#| echo: false
if converter:
    converter.convert("studies/xyz123/rtf/ae_summary.rtf", output_dir="docs/pdf/", format="pdf", overwrite=True)
```
...
#| echo: false
if converter:
    converter.convert("studies/xyz123/rtf/ae_summary_step.rtf", output_dir="docs/pdf/", format="pdf", overwrite=True)
```
