...
#| echo: false
if converter:
    converter.convert("studies/xyz123/rtf/ae_listing.rtf", output_dir="docs/pdf/", format="pdf", overwrite=True)
```
...
#| echo: false
if converter:
    converter.convert("studies/xyz123/rtf/ae_listing_step.rtf", output_dir="docs/pdf/", format="pdf", overwrite=True)
```
...
#| echo: false
if converter:
    converter.convert("studies/xyz123/rtf/ae_listing_custom.rtf", output_dir="docs/pdf/", format="pdf", overwrite=True)
```
