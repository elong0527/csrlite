...
for file in output_files:
    converter.convert(file, output_dir="pdf/", format="pdf", overwrite=True)
```
...
```{python}
#| echo: false
converter.convert("examples/rtf/ae_specific.rtf", output_dir="pdf/", format="pdf", overwrite=True)
```
...
```{python}
#| echo: false
converter.convert("examples/rtf/ae_specific_step.rtf", output_dir="pdf/", format="pdf", overwrite=True)
```
