...
def test_count_subject(population_data):
    result = count_subject(population=population_data, id="USUBJID", group="TRT01A", total=True)
...
def test_count_subject_no_total(population_data):
    result = count_subject(population=population_data, id="USUBJID", group="TRT01A", total=False)
